...
* Hugo 0.55.3: `0.55.3-busybox`, `busybox`, `0.55.3`, `latest`, `0.55.3-busybox-onbuild`, `0.55.3-onbuild`, `busybox-onbuild`, `onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.55.3/dist/busybox/Dockerfile-busybox))
...
* Hugo 0.55.3: `0.55.3-alpine`, `alpine`, `0.55.3-alpine-onbuild`, `alpine-onbuild`, `0.55.3-ext-alpine`, `ext-alpine`, `0.55.3-ext-alpine-onbuild`, `ext-alpine-onbuild`, `0.55.3-ext-nodejs`, `ext-nodejs` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.55.3/dist/alpine/Dockerfile-alpine))
...
* Hugo 0.55.3: `0.55.3-asciidoctor`, `asciidoctor`, `0.55.3-asciidoctor-onbuild`, `asciidoctor-onbuild`, `0.55.3-ext-asciidoctor`, `ext-asciidoctor`, `0.55.3-ext-asciidoctor-onbuild`, `ext-asciidoctor-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.55.3/dist/alpine/Dockerfile-asciidoctor))
...
* Hugo 0.55.3: `0.55.3-pandoc`, `pandoc`, `0.55.3-pandoc-onbuild`, `pandoc-onbuild`, `0.55.3-ext-pandoc`, `ext-pandoc`, `0.55.3-ext-pandoc-onbuild`, `ext-asciidoctor-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.55.3/dist/alpine/Dockerfile-pandoc))
...
* Hugo 0.55.3: `0.55.3-debian`, `debian`, `0.55.3-debian-onbuild`, `debian-onbuild`, `0.55.3-ext`, `ext`, `latest-ext`, `0.55.3-ext-debian`, `ext-debian`, `0.55.3-ext-debian-onbuild`, `ext-debian-onbuild`, `0.55.3-ext-onbuild`, `ext-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.55.3/dist/debian/Dockerfile-debian))
...
* Hugo 0.55.3: `0.55.3-ubuntu`, `ubuntu`, `0.55.3-ubuntu-onbuild`, `ubuntu-onbuild`, `0.55.3-ext-ubuntu`, `ext-ubuntu`, `0.55.3-ext-ubuntu-onbuild`, `ext-ubuntu-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.55.3/dist/ubuntu/Dockerfile-ubuntu))
...
```
docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/target klakegg/hugo:0.55.3
```

Run server:

```
docker run --rm -it -v $(pwd):/src -p 1313:1313 klakegg/hugo:0.55.3 server
```
...
```
docker run --rm -it -v $(pwd):/src klakegg/hugo:0.55.3-alpine shell
```
...
```Dockerfile
FROM klakegg/hugo:0.55.3-onbuild AS hugo
...
```
docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/src/public -e HUGO_PANDOC="pandoc-default --strip-empty-paragraphs" klakegg/hugo:0.55.3-pandoc
```
...
```
docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/src/public --entrypoint hugo klakegg/hugo:0.55.3
```
