...
* Hugo 0.38.1: `0.38.1-busybox`, `busybox`, `0.38.1`, `latest` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.38.1/Dockerfile))
...
* Hugo 0.38.1: `0.38.1-alpine`, `alpine` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.38.1/Dockerfile-alpine))
...
```docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/target klakegg/hugo:0.38.1```

Run server:

```docker run --rm -it -v $(pwd):/src -p 1313:1313 klakegg/hugo:0.38.1 server```
...
```docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/target --entrypoint hugo klakegg/hugo:0.38.1```
