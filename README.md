...
* Hugo 0.50: `0.50-busybox`, `busybox`, `0.50`, `latest`, `0.50-busybox-onbuild`, `0.50-onbuild`, `busybox-onbuild`, `onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.50/dist/busybox/Dockerfile-busybox))
...
* Hugo 0.50: `0.50-alpine`, `alpine`, `0.50-alpine-onbuild`, `alpine-onbuild`, `0.50-ext-alpine`, `ext-alpine`, `0.50-ext-alpine-onbuild`, `ext-alpine-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.50/dist/alpine/Dockerfile-alpine))
...
* Hugo 0.50: `0.50-asciidoctor`, `asciidoctor`, `0.50-asciidoctor-onbuild`, `asciidoctor-onbuild`, `0.50-ext-asciidoctor`, `ext-asciidoctor`, `0.50-ext-asciidoctor-onbuild`, `ext-asciidoctor-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.50/dist/alpine/Dockerfile-asciidoctor))
...
* Hugo 0.50: `0.50-pandoc`, `pandoc`, `0.50-pandoc-onbuild`, `pandoc-onbuild`, `0.50-ext-pandoc`, `ext-pandoc`, `0.50-ext-pandoc-onbuild`, `ext-asciidoctor-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.50/dist/alpine/Dockerfile-pandoc))
...
* Hugo 0.50: `0.50-debian`, `debian`, `0.50-debian-onbuild`, `debian-onbuild`, `0.50-ext`, `ext`, `latest-ext`, `0.50-ext-debian`, `ext-debian`, `0.50-ext-debian-onbuild`, `ext-debian-onbuild`, `0.50-ext-onbuild`, `ext-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.50/dist/debian/Dockerfile-debian))
...
* Hugo 0.50: `0.50-ubuntu`, `ubuntu`, `0.50-ubuntu-onbuild`, `ubuntu-onbuild`, `0.50-ext-ubuntu`, `ext-ubuntu`, `0.50-ext-ubuntu-onbuild`, `ext-ubuntu-onbuild` ([Dockerfile](https://github.com/klakegg/docker-hugo/blob/0.50/dist/ubuntu/Dockerfile-ubuntu))
...
```
docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/target klakegg/hugo:0.50
```

Run server:

```
docker run --rm -it -v $(pwd):/src -p 1313:1313 klakegg/hugo:0.50 server
```
...
```
docker run --rm -it -v $(pwd):/src klakegg/hugo:0.50-alpine shell
```
...
```Dockerfile
FROM klakegg/hugo:0.50-onbuild AS hugo
...
```
docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/src/public -e HUGO_PANDOC="pandoc-default --strip-empty-paragraphs" klakegg/hugo:0.50-pandoc
```
...
```
docker run --rm -it -v $(pwd):/src -v $(pwd)/output:/src/public --entrypoint hugo klakegg/hugo:0.50
```
